...
let RedirectType_VIPAdForm_ITwoRowImage: any = 25;
let objOfchangeMaxColSize: any = {};

export default HocForm({
  onInitValues(v: any) {
    // getSelection.call(this, "ShoppingList");
    // getSelection.call(this, "zhiyikaIdToCardNameList");
    // getSelection.call(this, "CollocationLookIdAndName");
      ...
      options: [
        ...
        },
        {
          ...
          onChange(r: any, v: any) {
            RedirectType_VIPAdForm_ITwoRowImage = r.RedirectType;
          },
        },
        {
          title: "跳转链接",
