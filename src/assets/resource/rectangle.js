...
class Rectangle {
  ...
  onDragStart(event) {
    ...
    console.log("this.graphics.parent", this.graphics.toLocal);
    // this.graphics.initialPosition = this.graphics.data.getLocalPosition(
    //   this.graphics.parent
    // );
    this.graphics.initialPosition = this.graphics.toLocal(this.graphics);
  ...
  onDragMove() {
    if (this.graphics.dragging) {
      ...
      //   this.graphics.parent
      // );
      // const newPosition = this.graphics.getBounds();
      const newPosition = this.graphics.toLocal(this.graphics);
