<template>
  <div class="wrapper">
    ...
    <div>
      <button @click="isGifAndDownLoad">表情包下载2</button>
    </div>
...
export default {
  ...
  setup(props, context) {
    ...
    let imgsArr = [];
    let inputValue = "";
    let imgUrl = new URL(`../assets/h5/7.jpg`, import.meta.url).href;
        ...
        if (gifInfo.images.length <= 1) {
          ...
          reader.onload = async (e) => {
            ...
            newImg.onload = () => {
              ...
              imgInfo.width = imgInfo.width < 300 ? imgInfo.width : 300;
              imgInfo.height = imgInfo.height < 270 ? imgInfo.height : 270;
